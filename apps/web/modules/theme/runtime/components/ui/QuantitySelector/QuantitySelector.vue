<template>
  <div class="inline-flex flex-col items-center" data-testid="quantity-selector">
    <div class="flex border border-gray rounded-[40px] h-full w-full">
      <SfTooltip
        v-if="count <= minValue"
      ...
      >
        <UiButton
          ...
          square
          class="rounded-r-none rounded-l-[40px]"
      ...
      <UiButton
        ...
        :disabled="disabled || count <= minValue"
        square
        class="rounded-r-none rounded-l-[40px] hover:bg-primary-500 hover:text-white"
        :aria-controls="inputId"
        :aria-label="t('product.decreaseQuantity')"
        data-testid="quantity-selector-decrease-button"
        @click="dec()"
      ...
      <UiButton
        ...
        square
        class="rounded-l-none rounded-r-[40px] hover:bg-primary-500 hover:text-white"
        :aria-controls="inputId"
