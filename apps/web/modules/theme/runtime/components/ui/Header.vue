<template>
  <MegaMenu :categories="categoryTree">
    <template v-if="viewport.isGreaterOrEquals('lg')">
      <UiSearch
        class="hidden lg:flex w-[785px] max-w-[785px] flex-[1_999_785px] min-w-0 [&_[data-testid='input']]:w-full [&_[data-testid='input']]:h-[50px] [&_[data-testid='input']]:!rounded-[40px] [&_[data-testid='input']]:overflow-hidden [&_[data-testid='input']]:!border-gray-dark [&_[data-testid='input']]:!bg-white [&_[data-testid='input']]:shadow-[inset_0_0_0_1px_var(--gray-dark)] [&_[data-testid='search-bar-input']]:min-w-0 [&_[data-testid='search-bar-input']]:w-full [&_[data-testid='search-bar-input']]:h-full [&_[data-testid='search-bar-input']]:!border-0 [&_[data-testid='search-bar-input']]:!rounded-[40px] [&_[data-testid='search-bar-input']]:bg-transparent"
      />
      <div class="hidden lg:flex lg:items-center lg:flex-nowrap shrink-0">
        <NuxtLink
          :to="localePath('/about-us')"
          class="text-black hover:text-primary-700 font-body font-normal text-base leading-[160%] whitespace-nowrap"
          >{{ t('theme.header.aboutUs') }}</NuxtLink
        >
        <NuxtLink
          :to="localePath('/faq')"
          class="ml-5 text-black hover:text-primary-700 font-body font-normal text-base leading-[160%] whitespace-nowrap"
