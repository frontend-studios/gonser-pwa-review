<template>
  <div class="hidden md:flex items-center absolute right-0 top-0 !m-0" data-testid="category-items-per-page">
    <div v-if="!selectionModeCompact" class="text-sm text-black whitespace-nowrap">
      {{ t('theme.CatView.perPage') }}
    </div>
    <div class="pl-4">
      <SfSelect
        id="perPage"
