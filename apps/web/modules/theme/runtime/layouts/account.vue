          ...
          >
            ...
            <li v-for="({ label, link }, subIndex) in getSubsections(subsections)" :key="`subsection-${subIndex}`">
              <SfListItem
                ...
                :to="localePath(link)"
                :class="[
                  'first-of-type:py-4 @md:first-of-type:px-4 @md:first-of-type:py-2 rounded-md active:bg-primary-500 !text-neutral-900',
                  {
                    'font-medium bg-primary-500': router.currentRoute.value.path === localePath(link),
                  },
                ]"
              >
